...
namespace PrzegladBazy.Models
{
    ...
    public partial class wizualizacja2Entities1 : DbContext
    {
        public wizualizacja2Entities1()
            : base("name=wizualizacja2Entities1")
        {
        }
        ...
        public virtual DbSet<pomiary_reczne_v> pomiary_reczne_v { get; set; }
        public virtual DbSet<v_elementy_grup> v_elementy_grup { get; set; }
        public virtual DbSet<v_pomiary_grup> v_pomiary_grup { get; set; }
        public virtual DbSet<wartosc_bramek> wartosc_bramek { get; set; }
        public virtual DbSet<wartosc_bramekver> wartosc_bramekver { get; set; }
    }
}
